...
export default function CourseHeader({
  ...
  if (hasCover) {
    return (
      <div
        className="relative overflow-hidden rounded-2xl px-4 py-6 sm:px-6 sm:py-8 md:px-10 md:py-10 bg-cover bg-center shadow-md"
        ...
        <div className="relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4">
            <div className="min-w-0 flex-1">
              <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white line-clamp-2 break-words">
                {course.title}
              </h1>
            ...
            <div className="shrink-0 self-start">
              <span className="inline-flex items-center rounded-lg bg-white/20 px-2.5 py-1 sm:px-3 sm:py-1.5 font-mono text-xs sm:text-sm font-bold text-white backdrop-blur-sm">
                {course.courseCode}
              </span>
            </div>
          </div>
  ...
  return (
    <div
      className="relative overflow-hidden rounded-2xl p-4 sm:p-6 md:p-8 bg-white dark:bg-[#141721] border border-slate-200/80 dark:border-white/5 border-l-4 shadow-sm"
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 sm:gap-4">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            <span
              className="inline-flex items-center px-2 py-0.5 rounded-md text-[11px] sm:text-xs font-bold font-mono uppercase tracking-wider"
              style={{
          ...
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900 dark:text-[#F0F2F8] line-clamp-2 break-words">
            {course.title}
          </h1>
        </div>
        <div className="shrink-0 self-start">
          <span
            className="inline-flex items-center rounded-lg sm:rounded-xl px-2.5 py-1 sm:px-3.5 sm:py-1.5 font-mono text-xs sm:text-sm font-bold shadow-2xs"
            style={{
