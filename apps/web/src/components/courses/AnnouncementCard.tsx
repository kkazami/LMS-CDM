        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-2">
            <div className="flex flex-wrap items-center gap-x-2 gap-y-1 min-w-0 flex-1">
              <span className="text-sm font-bold text-slate-900 dark:text-[#F0F2F8] truncate max-w-[160px] sm:max-w-none">
                {announcement.author.name}
              </span>
              {isCodeLabMilestone && (
                <span className="bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 text-[10px] font-bold px-2 py-0.5 rounded-full border border-indigo-500/20 shrink-0">
                  CodeLab Milestone
                </span>
              )}
              <span className="flex items-center gap-1 text-xs text-slate-400 dark:text-[#8B92A5] shrink-0">
            ...
            {canEditDelete && !isEditing && (
              <div className="flex items-center gap-1 shrink-0">
                <button
                  ...
                  className="rounded-lg p-1.5 text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-slate-600 dark:hover:text-slate-200 transition-colors min-h-[32px] min-w-[32px] flex items-center justify-center cursor-pointer"
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="rounded-lg p-1.5 text-slate-400 hover:bg-red-50 dark:hover:bg-red-950/30 hover:text-red-600 dark:hover:text-red-400 transition-colors min-h-[32px] min-w-[32px] flex items-center justify-center cursor-pointer"
